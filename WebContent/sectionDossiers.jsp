            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub" href="sectionDossiers.jsp">
...
<!--                                    </i>Modifier Dossier</button> -->
                        ...
                        <div class="row">
                        	<div  class="column">
                        	<form action = "controleur.php" method = post>
                        		<button  type = "submit" name = "action"  value = "addEmpl"><img src="myButtons/ajouter-dossier.png" width="250" height="250"  /></button>
                        	</form>	
                           	</div>
                        	<div class="column">
                        			<a href = "DossiersEnCours.php"><img src="myButtons/encours-dossiers.png" width="250" height="250"  /></a>
                        	</div>
                        ...
                        <div class="row">
                        	...
                        	<form action = "controleur.php" method = post>
                        			<a href = "DossiersNonTraitees.php"><img src="myButtons/failedfolder.png" width="242" height="242"  /></a>
                        	</form>
                        	</div>
                        	<div class="column">
                        	<form action = "controleur.php" method = post>
                        			<a href = "DossiersTraitees.php"><img src="myButtons/fertig-dossiers.png" width="250" height="250"  /></a>
                        	</form>
                        	</div>
                        </div>
                        <br>
