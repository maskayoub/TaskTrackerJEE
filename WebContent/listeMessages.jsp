                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Liste Messages Clients</h2>
...
<!--                                    </i>Modifier Dossier</button> -->
                       ...
                       <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                         <c:forEach items = "${messages}" var = "r">
                                            <tr class="tr-shadow">
                                                
                                                <td>${r.num_contact}</td>
                                                <td>
                                                    <span class="status--process">${r.nom_contact}</span>
                                                </td>
                                                <td>${r.email_contact}</td>
                                                
                                                <td>
                                                    <span>${r.sujet_contact}</span>
                                                </td>
                                                <td class="desc">${r.message_contact}</td>
                                                
                                                       <c:if test="${r.etat_contact}"><td><img src="myButtons/done.png" width="40" height="40"/></td></c:if><c:if test="${!r.etat_contact}"><td ><img src="myButtons/pending.png" width="40" height="40"  /></td></c:if>
													<td><a href="RepondreClient.php?action=replyContactOne&ref1=${r.num_contact}"><img src="myButtons/reply.png" width="40" height="40"  /></a></td>
