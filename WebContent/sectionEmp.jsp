                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <a class="js-arrow" href="indexClient.jsp">
                                <a href="empIndex.jsp"><i class="fas fa-desktop"></i>Platforme Client</a></a>
...
<!--                                    </i>Modifier Dossier</button> -->
                        ...
                        <div class="row">
                        	<div  class="column">
                        	<form action="ajoutEmploye.jsp">
                        		<button><img src="myButtons/ajouter-employé.png" width="250" height="250"  /></button>
                        	</form>	
                           	</div>
                        	
                        	<div class="column">
                        	
                        			<a href = "ModifierEmploye.php"><button><img src="myButtons/edit-emp.png" width="250" height="250"  /></button></a>
