                                        ...
                                        <tbody>
                                         <c:forEach items = "${modd.emp}" var = "r">
                                            <tr class="tr-shadow">
                                                ...
                                                <td>${r.num_emp}</td>
                                                <td>
                                                    <span class="status--process">${r.nom_emp}</span>
                                                </td>
                                                <td>${r.prenom_emp}</td>
                                                ...
                                                <td class="desc">${r.tel_emp}</td>
                                                <td ><span class="block-email">${r.email_emp}</span></td>
                                                <td>${r.cin_emp}</td>
                                                
                                                       <td>
												            <a href="ModificationEmploye.php?action=clickModifEmp&ref1=${r.num_emp}"><img src="myButtons/edit-icon-png-0.png" width="30" height="30"  /></a>
												       </td>
												       <td>
												            <a href="ListeEmployes.php?action=supEmp&ref1=${r.num_emp}"><img src="myButtons/icon-delete-16.jpg" width="30" height="30"  /></a>
												       </td>
