		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action = "controleur.php" method = post>
				...
				<div class="wrap-input100 validate-input" data-validate="Required">
					...
					<input id="nomEmp" class="input100" type="text" name="nomEmp" placeholder="Entrer le nom de l'employé">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<label class="label-input100" for="name">Prénom</label>
					<input id="preEmp" class="input100" type="text" name="preEmp" placeholder="Entrer le prénom de l'employé">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate = "Required">
					<label class="label-input100" for="message">Adresse</label>
					<textarea id="addEmp" class="input100" name="addEmp" placeholder="Entrer l'adresse ici..."></textarea>
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<label class="label-input100" for="name">Numéro Tel</label>
					<input id="telEmp" class="input100" type="text" name="telEmp" placeholder="Entrer le num tel de l'employé">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate = "L'email doit être sous le format: ex@abc.xyz">
					<label class="label-input100" for="email">Email</label>
					<input id="emailEmp" class="input100" type="text" name="emailEmp" placeholder="Entrer l'email...">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Required">
					<label class="label-input100" for="name">CIN</label>
					<input id="cinEmp" class="input100" type="text" name="cinEmp" placeholder="Entrer le CIN de l'employé">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Required">
					<label class="label-input100" for="name">Date De Naissance</label>
					<input id="dateNaissE" class="input100" type="date" name="dateNaissE" placeholder="Entrer la dat de naissance de l'employé">
					<span class="focus-input100"></span>
				</div>
				
				<div class="container-contact100-form-btn">
					<button class="contact100-form-btn" type = "submit" name = "action"  value = "ajouterEmploye">
						Ajouter
					</button>
				</div>
