...
<%--                                                          <td class="text-right"> <a href="TachesEmployes.php?action=supTache&ref1=${r.num_tache}"><img src="myButtons/icon-delete-16.jpg" width="20" height="20"  /></a></td> --%>
                                                        <td ><a href="TachesEmployes.php?action=approveTache&ref1=${r.num_tache}"><button type="button" class="btn btn btn-success">Ajouter</button></a></td>
                                                         <td ><a href="TachesEmployes.php?action=supprSugg&ref1=${r.num_tache}"><button type="button" class="btn btn-danger">Supprimer</button></a></td>
