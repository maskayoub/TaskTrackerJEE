                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Répondre Message</h2>
...
<!--                                    </i>Modifier Dossier</button> -->
                        ...
                        <div class="row" >
                        	<div class="col-lg-6">
                                <div class="card">
                             <form action = "RepondreClient.php"  method="post"  >
                                    <div class="card-header">
                                        <strong>Contenu Du</strong> Message
                                    </div>
                                    <div class="card-body card-block">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <p class="form-control-static">${nomc}</p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <p class="form-control-static">${sujetc}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <p class="form-control-static">${messagec}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="msgrep" placeholder="Votre message ici" id="msgrep" rows="9"  class="form-control"></textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer">
                                        <button type = "submit" name = "action"  value = "replyContactTwo" class="btn btn-primary btn-sm">
