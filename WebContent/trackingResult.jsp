...
<link href="trackingTemplate/css/style.css" rel="stylesheet" type="text/css" media="all" />
</head>
<body>
...
<div class="content">
	...
	<div class="content3">
        <div class="shipment">
			<div class="confirm">
                <div class="imgcircle">
                    <img src="trackingTemplate/images/confirm.png" alt="confirm order">
            	</div>
			...
			<div class="process">
           	 	<div class="imgcircle">
                	<img src="trackingTemplate/images/process.png" alt="process order">
            	</div>
				<span class="line"></span>
			...
			<div class="quality">
				<div class="imgcircle">
                	<img src="trackingTemplate/images/quality.png" alt="quality check">
            	</div>
				<span class="line"></span>
				<p>Quality Check</p>
			</div>
			<div class="dispatch">
				<div class="imgcircle">
                	<img src="trackingTemplate/images/dispatch.png" alt="dispatch product">
            	</div>
				<span class="line"></span>
				<p>Dispatched Item</p>
			</div>
			<div class="delivery">
				<div class="imgcircle">
                	<img src="trackingTemplate/images/delivery.png" alt="delivery">
				</div>
				<span class="line"></span>
