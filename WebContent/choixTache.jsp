      ...
      <div class="pricing-plan">
       ...
       <form action = "controleur.php" method = post>
        <div class="form-group">
			            <input  type="hidden"  type="text" class="form-control" value="${folder.num_doss}" name="numfolder" readonly>
          			</div>
          			<div class="form-group">
			            <input  type="hidden"  type="text" class="form-control" value="${folder.empl_courant.num_emp}" name="numempll" readonly>
          			</div>
          			
         <div class="form-group">
         <label>Nom Tache:</label>
			<select class="form-control"  name="tachenom">
		...
		<br>
        <button class="btn btn-primary" type = "submit" name = "action" value="confirmTask">Confirmer Tache</button>
    </form>
      </div>
