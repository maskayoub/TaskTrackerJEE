		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action = "ajouter.php" method = post>
				...
				<div class="wrap-input100 validate-input" data-validate="Required">
					<label class="label-input100" for="name">Nom Tâche</label>
					<input id="nomDoss" class="input100" type="text" name="nomtache" placeholder="Entrer le nom de la tâche...">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100">
					<div class="label-input100">Responsable de Tâche</div>
					<div>
