...
<!--                                 </ul> -->
                            ...
                            <li>
                             ...
                             <li>
                                <a href="platformeEmploye.php?action=suggestionTache">
                                    <i class="fas fa-check-square"></i>
                                    <span class="bot-line"></span>Suggérer Une Tache</a>
                            </li>
                            
                            <c:if test="${ajouter}">
                            <li>
                            <form class="form-inline" action = "platformeEmploye.php" method = post>
							 
							  <div class="form-group mx-sm-3 mb-2">
							    <label for="inputPassword2" class="sr-only">Password</label>
							    <input type="text" class="form-control" name="nomTache" placeholder="Nom Tache">
							  </div>
							  <button type="submit" name = "action" value="suggestionTache2" class="btn btn-primary mb-2">Envoyer</button>
							</form>
                            </li>
                            </c:if>
<!--                             <li class="has-sub"> -->
...
<!--                                                     </button></a>  -->
													<c:if test="${r.etat_doss != 'Echec De Traitement'}">
														...
														<c:if test="${r.progression_doss == 100}"><td data-toggle="tooltip" data-placement="top" title="Dossier Traité"><img src="myButtons/fertigen.png" width="40" height="40"/></td></c:if>
															<c:if test="${r.etat_doss != 'Attente'}"><td data-toggle="tooltip" data-placement="top" title="Confirmer Échec"><a href="echec.php?action=markFail&ref1=${r.num_doss}"><img src="myButtons/issue.png" width="50" height="50"/></a></td></c:if>
                                                	</c:if>
                                                	<c:if test="${r.etat_doss == 'Echec De Traitement'}">
